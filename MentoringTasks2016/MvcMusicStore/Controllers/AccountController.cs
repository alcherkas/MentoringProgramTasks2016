...
namespace MvcMusicStore.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private readonly Counters _performanceCounter = new Counters();
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            {
                _logger.Debug("Calling  UserManager FindAsync");
                var user = await _userManager.FindAsync(model.UserName, model.Password);
                if (user != null)
                {
                    _logger.Debug("Calling SignInAsync");
                    await SignInAsync(user, model.RememberMe);

                    _performanceCounter.IncrementLogin();

                    _logger.Debug("Calling RedirectToLocal");
                    return RedirectToLocal(returnUrl);
                }

                _logger.Error("Wrong user name or password");
        ...
        public ActionResult LogOff()
        {
            ...
            _performanceCounter.IncrementLogout();
            return RedirectToAction("Index", "Home");
        }
